...
labelStatic :: a -> LabelValue a -> Color -> Maybe Color -> ((Int, Int), (Int, Int)) -> View a
labelStatic a value color backg bounds = label a (to (\_ -> initLabel value color backg)) bounds
